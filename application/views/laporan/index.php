                        ...
                        <div class="container ">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p class="float-right"><?= "Rp." . number_format($Lkas, 0, ",", ","); ?></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <p class="float-left">Piutang Dagang</p>
                                    <p class="float-right"><?= "Rp." . number_format($Lpiutang, 0, ",", ","); ?></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <p class="float-left">Perlengkapan</p>
                                    <p class="float-right"><?= "Rp." . number_format($Lperlengkapan, 0, ",", ","); ?></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <p class="float-left">Sewa dibayar dimuka</p>
                                    <p class="float-right"><?= "Rp." . number_format($Lsewadibayardimuka, 0, ",", ","); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p class="float-right"><?= "Rp." . number_format($Lperalatan, 0, ",", ","); ?></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <p class="float-left">Akumulasi Penyusutan</p>
                                    <p class="float-right">(<?= "Rp." . number_format($Lakumulasi, 0, ",", ","); ?>)</p>
                                </div>
                            </div>
                            <hr>
                        ...
                        <div class="container ">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p class="float-right"><?= "Rp." . number_format($Lhutang, 0, ",", ","); ?></p>
                                </div>
                            </div>
